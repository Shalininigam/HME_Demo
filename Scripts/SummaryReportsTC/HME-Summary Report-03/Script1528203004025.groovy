...
try {
	...
	WebUI.delay(5)
	String toDate="(//div[@class='rdtPicker']/div/table/tbody/tr/td[text()='"+CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","EndDate9")+"'])[3]"
	println toDate
	...
	println attr
	String toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","toDate10")
	...
	String startTimeText =WebUI.getText(findTestObject('SummarizedReportPage/startDateText')).trim()
	...
	String endTimeText =WebUI.getText(findTestObject('SummarizedReportPage/endDateText')).trim()
	WebUI.verifyMatch(endTimeText,endTime,false)


	//Step5: To verify the print time
	def today = new Date()
	println today.format("d")
	String todayDate = today.format("d")
	...
	if(date1.contains(todayDate)){
		println "print time matched"
	}else{

		if(TCflag)
			TCflag=false
		println "print time not matched"
	}
	...
	CustomKeywords.'projectSpecific.Reusability.getTestData'("SummarizedReportPage","firstDateRange1"))
	...
	CustomKeywords.'uiaction.CommonUIActions.click'(findTestObject('SummarizedReportPage/nextPageIcon'))
	...
	CustomKeywords.'uiaction.CommonUIActions.click'(findTestObject('SummarizedReportPage/allReportsLink'))
	WebUI.delay(15)
	...
	String date2 = CustomKeywords.'uiaction.CommonUIActions.getText'(findTestObject('SummarizedReportPage/printDateValue'))
	if(date2.contains(todayDate)){
	...
	reportHeaders =CustomKeywords.'projectSpecific.Reusability.getTestData'("SummarizedReportPage","ReportsColumnHeader4")
	reportsArray=reportHeaders.split(',')
	reportsHeaderList=new ArrayList(Arrays.asList(reportsArray))
	reportsHeaderList.unique()
	System.out.println(reportsHeaderList)
	columnHeaderList = driver.findElements(By.xpath(findTestData('OR_file').getValue(2, 27)))
	...
	String groupmain1=CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportingGroupManagementPage","dummyGroupName1")
	driver.findElement(By.xpath("//span[contains(text(),'"+groupmain1+"')]/../../../../span[1]")).click()

	driver.findElement(By.xpath("//span[contains(text(),'"+groupmain1+"')]/../../../../span[2]")).click()
	'Select time'
	...
	WebUI.delay(5)
	toDate="(//div[@class='rdtPicker']/div/table/tbody/tr/td[text()='"+CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","EndDate9")+"'])[3]"
	println toDate
	...
	attr =WebUI.getAttribute(findTestObject('ReportsPage/selectedDate1'),"value")
	println attr
	toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","toDate10")
	...
	WebUI.delay(GlobalVariable.MED_DELAY)
	CustomKeywords.'uiaction.CommonUIActions.click'(findTestObject('ReportingGroupManagement/dummarysummaRY'))
	WebUI.delay(GlobalVariable.MED_DELAY)
